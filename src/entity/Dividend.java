...
public class Dividend {
    ...
    public Dividend(String dividendID, String dCompanyIndex, String stockType, String dividendType, String approvalDate, String xdDate, String paymentDate) {
    ...
    public String getdCompanyIndex() {
